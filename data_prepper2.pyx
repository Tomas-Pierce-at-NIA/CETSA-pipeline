...
class DataPreparer:
    ...
    def __init__(self, focused_data: pandas.DataFrame):
    ...
    def transform(self, focused_data: pandas.DataFrame, category1: str, category2: str):
        ...
        return interact_data, outputs, treatments
